...
namespace TO
{
    public class TOHistorialMedico
    {
        ...
        public TOHistorialMedico(string cedula, string antecedentes, string patologias, int consumeLicor, int fuma, string frecFuma, string frecLicor, DateTime ultimoExamen)
        {
            Cedula = cedula;
