...
namespace TO
{
    public class TOHabitoAlimentario
    {
        ...
        public TOHabitoAlimentario(string cedula, int comidaDiaria, int comidaHorasDia, int afueraExpress, string comidaFuera, string azucarBebida, string comidaElaboradCon, decimal aguaDiaria, int aderezos, int fruta, int verdura, int leche, int huevo, int yogurt, int carne, int queso, int aguacate, int semillas)
        {
            Cedula = cedula;
