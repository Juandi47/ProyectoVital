        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <asp:GridView ID="grdEjercicios" runat="server" class="table table-bordered text-center" BackColor="Silver" Font-Size="X-Large" AutoGenerateDeleteButton="True" OnRowDeleting="grdEjercicios_RowDeleting">
