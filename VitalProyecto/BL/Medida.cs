...
namespace BL
{
    public class Medida
    {
        ...
        public Medida(string frec_Cardiaca, double peso, double porcent_Grasa, double iMC, double cintura, double abdomen, double cadera, double muslo, double estatura, double ced_Cliente)
        {
